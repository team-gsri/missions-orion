...
T8L_var_fileSize = 50000;  								// Filesize ... smaller files will take shorter time to download!

T8L_var_TLine01 = "Telechargement abandonne";				// download aborted
T8L_var_TLine02 = "Deja en cours";			// download already in progress by someone else
T8L_var_TLine03 = "Telechargement demarrer";				// download started
T8L_var_TLine04 = "Telechargement fini";			// download finished
T8L_var_TLine05 = "##  Telechargement  ##";				// line for the addaction
