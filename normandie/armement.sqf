...
_hammer setPosASL (_navire modelToWorld [0,-79.08,12.1]);
...
_vls setPosASL (_navire modelToWorld [0,-62.4229,10.7]);
...
_aa1 setPosASL (_navire modelToWorld [0,-48.106,15.1]);
...
_aa2 setPosASL (_navire modelToWorld [0,36.3765,19.3]);
...
_spartan setPosASL (_navire modelToWorld [0,50.6011,15.8]);
